...
11. Review the preview with the user. Read rendered PNG frames directly to make visual judgments about arc, composition, contrast, motif development, and pacing. If the piece is flat, repetitive, or off-mode, change structure or behavior before raising fidelity.
