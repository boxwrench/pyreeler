---
name: pyreeler
description: Design and deliver sub-60-second code-generated films, loops, and experimental motion pieces with a final-product-first workflow. Use when Codex needs to turn a loose idea into a preview, iterate with artistic judgment, export the final piece to the Videos folder, offer upscale options, and keep the production process clean and repeatable without becoming formulaic.
---
