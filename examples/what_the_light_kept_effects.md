...
- Current implementation:
  - sampled heart/brain target points
  - additive NumPy particle accumulation into a float buffer
  - two-stage glow blur and light grain
  - Code references: [render_preview.py](/C:/Github/pyreeler/assets/showcase/what-the-light-kept/render_preview.py#L126), [render_preview.py](/C:/Github/pyreeler/assets/showcase/what-the-light-kept/render_preview.py#L302)
- Notes:
  - this now uses the emergence-style `misty particles + target-form emergence` combination
  - it is the v2 ending variant for this piece
